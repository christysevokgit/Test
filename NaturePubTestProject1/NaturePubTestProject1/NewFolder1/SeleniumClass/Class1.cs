...
namespace NatureTestExercise.SeleniumTest_Class

{
    class NatureSearch_Selenium

    {
        ...
        public NatureSearch_Selenium(IWebDriver driver)
        ...
        public void SearchField(string SearchField)
        {
            ...
            driver.FindElement(By.Id("query")).SendKeys(SearchField);
            Thread.Sleep(4000);
